#ifndef phin6  // always here. give a unique name for this library
#define phin6  // always here. give a unique name for this library
...
class Phin6  { // usually named the same as the header but it's not necessary
  public: // which functions do we want available to call from another program
    ...
    Phin6(bool displayMsg=false); // false sets the default if there is no parameter entered. constructor must be the same name as the class
